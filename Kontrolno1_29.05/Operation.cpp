...
static vector<Magazin> v_magazin;
static vector<Magazin> v_magazin3;
static vector<Magazin> v_magazin2;
...
void  Operation::articulWinner(){
    ...
    for (size_t i = 0; i < v_magazin.size(); i++) {
      // cout << v_magazin.at(i).getQuantity();
      //  cout <<v_magazin[0].getQuantity();
        if(v_magazin[0].getQuantity() >= v_magazin[1].getQuantity() || v_magazin[1].getQuantity() >= v_magazin[2].getQuantity() ){
            win1 =  v_magazin[0].getQuantity();
        }
        
        if(v_magazin[1].getQuantity() >= v_magazin[0].getQuantity() || v_magazin[1].getQuantity() >= v_magazin[2].getQuantity() ){
            win1 = v_magazin[1].getQuantity();
        }
        
        if(v_magazin[2].getQuantity() >= v_magazin[0].getQuantity() || v_magazin[1].getQuantity() >= v_magazin[0].getQuantity() ){
          win1 =   v_magazin[2].getQuantity();
        }
    }
    for (size_t i = 0; i < v_magazin2.size(); i++) {
        // cout << v_magazin2.at(i).getQuantity();
        //  cout <<v_magazin2[0].getQuantity();
        if(v_magazin2[0].getQuantity() > v_magazin2[1].getQuantity() || v_magazin2[1].getQuantity() > v_magazin2[2].getQuantity() ){
            win2 =  v_magazin2[0].getQuantity();
        }
        
        if(v_magazin2[1].getQuantity() > v_magazin2[0].getQuantity() || v_magazin2[1].getQuantity() > v_magazin2[2].getQuantity() ){
            win2 = v_magazin2[1].getQuantity();
        }
        
        if(v_magazin2[2].getQuantity() > v_magazin2[0].getQuantity() || v_magazin2[1].getQuantity() > v_magazin2[0].getQuantity() ){
            win2 =   v_magazin2[2].getQuantity();
        }
    }
    for (size_t i = 0; i < v_magazin3.size(); i++) {
        // cout << v_magazin.at(i).getQuantity();
        //  cout <<v_magazin3[0].getQuantity();
        if(v_magazin3[0].getQuantity() > v_magazin3[1].getQuantity() && v_magazin3[1].getQuantity() > v_magazin3[2].getQuantity() ){
            win3 =  v_magazin3[0].getQuantity();
        }
        
        if(v_magazin3[1].getQuantity() > v_magazin3[0].getQuantity() && v_magazin3[1].getQuantity() > v_magazin3[2].getQuantity() ){
            win1 = v_magazin3[1].getQuantity();
        }
        
        if(v_magazin3[2].getQuantity() > v_magazin3[0].getQuantity() && v_magazin3[1].getQuantity() > v_magazin3[0].getQuantity() ){
            win3 =   v_magazin3[2].getQuantity();
        }
    }
