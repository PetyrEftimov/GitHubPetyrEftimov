...
//                //Render background
//               //
//               // gBackground.setAlpha(200);
//                gBackground.setBlendMode(SDL_BlendMode::SDL_BLENDMODE_BLEND);
//                
//               // gBackground.setColor(0xCC, 0xAA, 0xFF);
//                
//                gBackground.render( 0, 0, NULL );
//                
//                
//                //logic from mouseClickEvent
//                if(flag ==true)
//                {
//                    if(isOdd == true)
//                    {
...
//                    }
//                    else{
//                        img2.setWidth(img2.getWidth());
//                        img2.setheight(img2.getHeight());
//                        img2.render( currentX, currentY, NULL );
//                    }
//                
//                }
//                
